...
[data-theme="dark"] table.ars-table tbody tr:nth-child(odd)  { background-color: #1e222d; }   
[data-theme="dark"] table.ars-table tbody tr:nth-child(even) { background-color: #151821; }
[data-theme="dark"] table.ars-table tbody tr:hover           { background-color: #2a303e; }
