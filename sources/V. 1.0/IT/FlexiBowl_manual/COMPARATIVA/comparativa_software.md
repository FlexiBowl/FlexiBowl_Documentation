...
- **Via protocollo WRITE**: ControlWord blocco WRITE → formula: `N × 100 + offset_parametro`
- **Via protocollo READ**: ControlWord blocco READ → formula: `10000 + N × 100 + offset_parametro`
