...
Il pannello **STATE MOTOR** mostra lo stato operativo corrente del driver motore tramite una serie di indicatori luminosi (LED virtuali). Ogni LED può essere:
...
|---|---|
| **Not Ready To Switch On** | Il driver non è pronto per l'abilitazione. Condizione iniziale o di errore |
...
| **!** | — | Icona di alert: si illumina quando è presente un codice di errore diverso da zero |
...
| Pulsante | Funzione |
|---|---|
| **ACK selected** | Conferma (acknowledge) il messaggio selezionato nella tabella, marcandolo come preso in carico |
